...
export default function LimestoneExcavation() {
  ...
  return (
    <div className="limestone-page fade-in">
      <Breadcrumbs items={[{ label: 'Limestone Excavation' }]} />
      ...
      <section className="cta-calc-section" style={{padding: '60px 0', background: 'var(--light)', borderBottom: '1px solid var(--border)'}}>
        <div className="container grid-split" style={{alignItems: 'center'}}>
          ...
          <div className="calc-side">
            <Calculator variant="light" source="limestone_authority" />
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="process-grid-main">
            ...
            <div className="p-item-card">
              ...
              <p className="authority-text">Broken limestone is sorted. Clean rock can often be repurposed for on-site drainage layers, saving you disposal costs. Once the limestone shelf is properly leveled, we transition to our <Link href="/engineered-backfill" style={{color: 'var(--primary)', textDecoration: 'underline'}}>engineered backfill and compaction process</Link> to ensure the site is ready for new construction.</p>
          </div>
          </div>

          {/* TECHNICAL DATA TABLE */}
          <div className="tech-matrix mt-60" style={{background: 'rgba(255,255,255,0.02)', padding: '40px', borderRadius: '24px', border: '1px solid rgba(255,255,255,0.05)'}}>
            <h3 className="white mb-30" style={{fontSize: '1.2rem', textAlign: 'center'}}>Technical Breaking Matrix</h3>
            <div style={{overflowX: 'auto'}}>
              <table style={{width: '100%', borderCollapse: 'collapse', color: 'rgba(255,255,255,0.7)', fontSize: '0.9rem'}}>
                <thead>
                  <tr style={{borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
                    <th style={{padding: '15px', textAlign: 'left', color: 'white'}}>Rock Type</th>
                    <th style={{padding: '15px', textAlign: 'left', color: 'white'}}>Hammer Class</th>
                    <th style={{padding: '15px', textAlign: 'left', color: 'white'}}>Impact (ft-lb)</th>
                    <th style={{padding: '15px', textAlign: 'left', color: 'white'}}>Avg. Breaking Depth</th>
                  </tr>
                </thead>
                <tbody>
                  <tr style={{borderBottom: '1px solid rgba(255,255,255,0.05)'}}>
                    <td style={{padding: '15px'}}>Soft Shell Limestone</td>
                    <td style={{padding: '15px'}}>1,500 Class</td>
                    <td style={{padding: '15px'}}>1,200 - 1,500</td>
                    <td style={{padding: '15px'}}>12" - 18" / hr</td>
                  </tr>
                  <tr style={{borderBottom: '1px solid rgba(255,255,255,0.05)'}}>
                    <td style={{padding: '15px'}}>Nashville Blue Rock</td>
                    <td style={{padding: '15px'}}>3,000 Class</td>
                    <td style={{padding: '15px'}}>2,800 - 3,200</td>
                    <td style={{padding: '15px'}}>6" - 10" / hr</td>
                  </tr>
                </tbody>
              </table>
            </div>
      ...
      {/* FAQ SECTION - Deep Authority */}
      <section className="faq-section" style={{padding: '100px 0'}}>
        <div className="container max-800">
          <h2 className="section-title text-center mb-60">Rock Breaking <span className="text-grad">Excellence FAQ</span></h2>
          <div className="faq-list" style={{display: 'flex', flexDirection: 'column', gap: '30px'}}>
             <div className="faq-item">
                <h4 style={{marginBottom: '10px', color: 'var(--dark)'}}>Will the vibrations damage my home's foundation?</h4>
                <p style={{color: 'var(--secondary)', lineHeight: '1.6'}}>No. We use "Micro-Fracturing" techniques where we break the rock in small, focused increments rather than large impacts. We also maintain a minimum setback distance from primary structures to ensure 0% seismic risk.</p>
             </div>
             <div className="faq-item">
                <h4 style={{marginBottom: '10px', color: 'var(--dark)'}}>How do you know where the rock is?</h4>
                <p style={{color: 'var(--secondary)', lineHeight: '1.6'}}>We analyze the Nashville Geological Basin maps for your specific neighborhood (e.g., Green Hills sits on a shallower shelf than East Nashville). For high-precision sites, we offer GPR (Ground Penetrating Radar) scanning.</p>
             </div>
             <div className="faq-item">
                <h4 style={{marginBottom: '10px', color: 'var(--dark)'}}>Does rock removal cost more?</h4>
                <p style={{color: 'var(--secondary)', lineHeight: '1.6'}}>While rock breaking does require more machine hours, our flat-rate day pricing ensures you aren't hit with "hidden" cubic-yard surcharges that many standard contractors apply when they hit a shelf.</p>
             </div>
          </div>
        </div>
      </section>
